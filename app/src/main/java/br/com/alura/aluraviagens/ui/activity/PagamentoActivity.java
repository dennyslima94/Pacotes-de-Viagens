...
public class PagamentoActivity extends AppCompatActivity {
    ...
    private void configuraBotao(final Pacote pacote) {
        Button botaoFinalizaCopra = findViewById(R.id.pagamento_botao);
        botaoFinalizaCopra.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void mostraPreco(Pacote pacote) {
        TextView preco = findViewById(R.id.pagemnto_preco_pacote);
