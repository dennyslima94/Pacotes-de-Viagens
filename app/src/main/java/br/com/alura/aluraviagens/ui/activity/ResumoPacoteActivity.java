...
public class ResumoPacoteActivity extends AppCompatActivity {
    ...
    private void configuraBotao(final Pacote pacote) {
        Button botaoRealizarPagamento =findViewById(R.id.resume_pacote_botao);
    ...
    private void vaiParaPagamento(final Pacote pacote) {
    ...
    private void mostraData(Pacote pacote) {
        TextView data = findViewById(R.id.resume_pacote_data);
